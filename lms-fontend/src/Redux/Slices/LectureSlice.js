...
export const getCourseLecture=createAsyncThunk("/course/lecture/get",async(cid)=>{
    try {
        const response = axoisInstance.get(`/courses/${cid}`);
...
export const addCourseLecture = createAsyncThunk("/course/lecture/add", async (data) => {
    try {
        ...
        const response = axoisInstance.post(`/courses/${data.id}`, formData);
        toast.promise(response, {
...
export const deleteCourseLecture = createAsyncThunk("/course/lecture/delete", async (data) => {
    try {
        const response = axoisInstance.delete(`/courses?courseId=${data.courseId}&lectureId=${data.lectureId}`);
        toast.promise(response, {
            loading: "Fetching course lectures",
            success: "Fetched course lectures",
            error: "Failed load the lectures"
